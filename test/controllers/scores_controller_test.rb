...
class ScoresControllerTest < ActionController::TestCase
  ...
  test "should create score" do
    assert_difference('Score.count') do
      post :create, score: { star: @score.star, university_id: @score.university_id, user_id: @score.user_id }
    end
  ...
  test "should update score" do
    patch :update, id: @score, score: { star: @score.star, university_id: @score.university_id, user_id: @score.user_id }
    assert_redirected_to score_path(assigns(:score))
  end
