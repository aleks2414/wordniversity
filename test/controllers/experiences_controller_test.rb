...
class ExperiencesControllerTest < ActionController::TestCase
  ...
  test "should create experience" do
    assert_difference('Experience.count') do
      post :create, experience: { experience: @experience.experience, university_id: @experience.university_id, user_id: @experience.user_id }
    end
  ...
  test "should update experience" do
    patch :update, id: @experience, experience: { experience: @experience.experience, university_id: @experience.university_id, user_id: @experience.user_id }
    assert_redirected_to experience_path(assigns(:experience))
  end
